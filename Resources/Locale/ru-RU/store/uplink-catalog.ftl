...
uplink-syndicate-id-card-name = Карта личности Синдиката
uplink-syndicate-id-card-desc = Карта личности Синдиката с доступом к его системам. Сама по себе вряд ли полезна, но отлично работает с перенастроенными дверями. Не имеет функции копирования доступа.
...
uplink-briefcase-gun-desc = Неприметный портфель с компактным C-20r, встроенным внутрь. Осторожнее — не сжимайте ручку слишком сильно!
uplink-energycrossbow-name = Мини-энергоарбалет
uplink-energycrossbow-desc = Идеальное оружие для оперативников, предпочитающих, чтобы их цели не двигались. Стреляет самовосстанавливающимися токсичными болтами, мгновенно валящими жертву с ног.
