...
criminal-records-console-hostile = { $name } ({ $job }) был(а) отмечен(а) как враг корпорации { $officer } по причине: { $reason }.
criminal-records-console-not-hostile = { $name } ({ $job }) больше не считается врагом корпорации по решению { $officer }.
criminal-records-console-eliminated = { $name } ({ $job }) был(а) отмечен(а) как ликвидированный(ая) { $officer }.
criminal-records-console-not-eliminated = { $name } ({ $job }) больше не считается ликвидированным(ой) по решению { $officer }.
