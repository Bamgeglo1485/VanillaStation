...
admin-verbs-bar-job-slots = Заблокировать вакансии
...
admin-verbs-dialog-redescribe-title = Изменение описания
admin-verbs-dialog-redescribe-description = Описание
admin-verbs-dialog-rename-and-redescribe-title = Переименование и описание
admin-verbs-dialog-set-bullet-amount-title = Количество пуль
