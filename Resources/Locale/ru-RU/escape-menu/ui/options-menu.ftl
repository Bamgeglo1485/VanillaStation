...
ui-options-function-smart-equip-pocket2 = Умная экипировка в карман 1
...
ui-options-function-inspect-entity-tooltip = Открыть окно ViewVariables для сущности, на которую наведён курсор.
ui-options-function-inspect-server-component = Проверить серверный компонент
ui-options-function-inspect-server-component-tooltip = Открыть окно ViewVariables с серверным компонентом, установленным командой «quickinspect», для сущности под курсором.
ui-options-function-inspect-client-component = Проверить клиентский компонент
ui-options-function-inspect-client-component-tooltip = Открыть окно ViewVariables с клиентским компонентом, установленным командой «quickinspect», для сущности под курсором.
